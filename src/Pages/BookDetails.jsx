...
//if you clicked on the "The Alchemist" book whose id is 8.
...
console.log('expected book',expectedBook)//returns the element(object of a book in this case) that matches the condition

//deconstructing the expectedBook object
const {bookName, author,image, review, totalPages, rating,yearOfPublishing, publisher, tags,  category} = expectedBook;
...
<div className="card gap-2 lg:card-side bg-base-100 shadow-sm container mx-auto">
  <figure>
    <img
      src={image} className="h-[400px] w-[1700px]"/>
  </figure>
